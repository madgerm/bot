...
- [`mvp-und-entscheidungen.md`](mvp-und-entscheidungen.md) — **MVP-Kern, Reihenfolge, Trigger, Web-Zugang, Auth, technische Defaults**; Erweiterung **Team-Medien** (Vision-LLM, STT/TTS, Bildgenerierung: Webhook / self-hosted / MiniMax; **pro Kanal global oder individuell**).
